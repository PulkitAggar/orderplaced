...
import '../components/BMOurServiceComponentTwo.dart';
import '../models/BMCommonCardModel.dart';
import '../utils/BMColors.dart';
import '../utils/BMCommonWidgets.dart';

class SingleStoreScreenTwo extends StatefulWidget {
  BMCommonCardModel element;

  SingleStoreScreenTwo({required this.element});

  @override
  State<SingleStoreScreenTwo> createState() => _SingleStoreScreenTwoState();
}

class _SingleStoreScreenTwoState extends State<SingleStoreScreenTwo> {
  @override
  void initState() {
      ...
      body: NestedScrollView(
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                BMOurServiceComponentTwo(storeUid: widget.element.storeUid),
              ],
            ),
          ),
        ),
