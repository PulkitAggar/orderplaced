...
import 'package:mycycleclinic/screens/home_screen_two.dart';
...
class SelectCityTwo extends StatefulWidget {
  const SelectCityTwo({super.key});

  @override
  State<SelectCityTwo> createState() => _SelectCityTwoState();
}

class _SelectCityTwoState extends State<SelectCityTwo> {
      ...
      onTap: () {
        if (locationData.price == 'Coming soon...') {
          ...
          Navigator.of(context).pushReplacement(MaterialPageRoute(
              builder: (context) => DashboardTwo(locationData.location)));
        }
      },
      child: Stack(
        children: [
