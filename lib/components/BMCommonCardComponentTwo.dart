...
import '../screens/single_store_screen.dart';
import '../screens/single_store_screen_two.dart';
import '../utils/BMCommonWidgets.dart';

class BMCommonCardComponentTwo extends StatefulWidget {
  ...
  @override
  State<BMCommonCardComponentTwo> createState() =>
      _BMCommonCardComponentTwoState();
}

class _BMCommonCardComponentTwoState extends State<BMCommonCardComponentTwo> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      SingleStoreScreenTwo(element: widget.element).launch(context);
    });
  }
}
