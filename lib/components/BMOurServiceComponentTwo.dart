...
class BMOurServiceComponentTwo extends StatefulWidget {
  String storeUid;

  BMOurServiceComponentTwo({required this.storeUid});

  @override
  State<BMOurServiceComponentTwo> createState() =>
      _BMOurServiceComponentTwoState();
}

class _BMOurServiceComponentTwoState extends State<BMOurServiceComponentTwo> {
  late String storeid;
