...
List<BMMasterModel> getTopServicesHomeList() {
  ...
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/salon.png', name: 'Stores'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/makeup_kit.png', name: 'Services'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/nail-polish.png', name: 'Tires'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/makeup.png', name: 'Accesories'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/makeup_kit.png', name: 'Bikes'));
